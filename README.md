...
*   **Functionality:** Classifies users into actionable segments:
    ...
    *   ⚠️ **At-Risk Customer:** High churn probability requiring win-back campaigns.
...
---
```bash
git clone [https://github.com/adarsh-tiwari29/shopper_spectrum_project.git](https://github.com/adarsh-tiwari29/shopper_spectrum_project.git)
